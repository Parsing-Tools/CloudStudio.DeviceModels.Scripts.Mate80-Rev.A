...
# Configuration Script – Mate80 - Rev. A

This **Configuration** script is designed for the **Mate80** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – Mate80 Rev. A

Este script de **Configuration** está diseñado para el modelo **Mate80** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
